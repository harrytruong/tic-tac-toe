...
System.register('src/models/Intel', ['npm:babel-runtime@5.8.20/helpers/get', 'npm:babel-runtime@5.8.20/helpers/inherits', 'npm:babel-runtime@5.8.20/helpers/create-class', 'npm:babel-runtime@5.8.20/helpers/class-call-check', 'npm:babel-runtime@5.8.20/core-js/get-iterator', 'npm:lodash@3.10.1', 'github:jashkenas/backbone@1.2.1', 'src/models/Grid'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            ...
            anyEq = function anyEq(match, data) {
                return _.any(data, _.partial(_.eq, match));
            };
...
System.register('src/models/Grid', ['npm:babel-runtime@5.8.20/helpers/get', 'npm:babel-runtime@5.8.20/helpers/inherits', 'npm:babel-runtime@5.8.20/helpers/create-class', 'npm:babel-runtime@5.8.20/helpers/class-call-check', 'npm:babel-runtime@5.8.20/core-js/get-iterator', 'npm:lodash@3.10.1', 'github:jashkenas/backbone@1.2.1'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, _getIterator, _, Backbone, everyEq, findPick, findPickEveryEq, solveGrid, Grid;
    ...
    return {
        ...
        execute: function () {
            ...
            everyEq = function everyEq(match, data) {
                return _.every(data, _.partial(_.eq, match));
            };

            findPick = function findPick(data, picks, predicate) {
                return _.find(picks, function (pick) {
                    return predicate(_.pick(data, pick));
                });
            };

            findPickEveryEq = function findPickEveryEq(match, data, picks) {
                return findPick(data, picks, _.partial(everyEq, match));
            };
            ...
            Grid = (function (_Backbone$Model) {
                ...
                _createClass(Grid, [{
                    ...
                    value: function reset() {
                        return this.resetData().resetHistory().trigger("reset", this);
                    }
                    ...
                    value: function mark(position, _mark) {
                        ...
                        if (status) {
                            var solved = status instanceof Array ? _mark : "tied";
...
System.register('src/views/GameView', ['npm:babel-runtime@5.8.20/helpers/get', 'npm:babel-runtime@5.8.20/helpers/inherits', 'npm:babel-runtime@5.8.20/helpers/create-class', 'npm:babel-runtime@5.8.20/helpers/class-call-check', 'github:jashkenas/backbone@1.2.1', 'src/models/Grid', 'src/models/Intel', 'src/views/GameView.ust!github:harrytruong/ust@master'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, Backbone, Grid, Intel, Template, GameView;
    ...
    return {
        setters: [function (_npmBabelRuntime5820HelpersGet) {
            ...
            Template = _srcViewsGameViewUstGithubHarrytruongUstMaster['default'];
        }],
        execute: function () {
            /**
